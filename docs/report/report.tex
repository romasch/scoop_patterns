...
We implemented the Gaussian elimination algorithm \todoref in three different ways: sequentially, with SCOOP only, and using the future module (see Section \ref{sec:futures} from the library.
