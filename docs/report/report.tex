...
\begin{itemize}
 ...
 This selection was mainly based on input from the CME team \todoref and the study of the Java \cite{web:java-concurrency} and C\# \cite{web:ms-tpl} concurrency libraries.
\end{itemize}
...
% \item [Agent integration] \todo{maybe?}
 ...
 \todo{add data level parallelism.}
\end{description}
