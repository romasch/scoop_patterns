...
\begin{itemize}
 \item Due to a technique called ``lock passing'' \todo{ref: piotr and eiffel docs}, \lstinline!do_something! is executed synchronously, i.e. the sender has to wait for it to finish.
...
\todo{Put the remaining section into an appendix?}
