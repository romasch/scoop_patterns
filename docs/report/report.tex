...
%   ,applicability={}
  ...
  ,example={When a buffer is empty, a consumer can wait on the is_not_empty conditon variable. Producers will signal on this variable when a new item is available.}
