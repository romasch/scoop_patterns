...
SCOOP, an extension to the Eiffel programming language, provides an alternative approach to concurrent programming compared to the threading model used in many other languages.
...
\todo{Some letters are de-capitalized in  bibliography section. Why?}
\end{flushleft}
