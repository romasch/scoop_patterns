...
% To inform the user that the background task has actually finished the user interface subscribes to the termination event with the \lstinline!on_terminated! handler.
