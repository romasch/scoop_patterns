...
\pattern [name={Producer / Consumer}
 ...
 ,references={\cite[p. 87]{book:java-concurrency}, \cite[p. 53]{Toub10}}
]
...
\pattern [name={Pipeline}
 ...
 ,references={\cite[p. 305]{book:cpj}, \cite[p. 253]{book:spp}, \cite[p. 53]{Toub10}}
]
...
\pattern [name={Worker Pool}
 ...
 ,references={\cite[p. 117]{book:java-concurrency}, \cite[p. 167]{book:java-concurrency}, \cite[p. 290]{book:cpj},  \cite[p. 61]{Toub10}, \cite{Leijen09}}
]
...
\pattern [ name={Future}
 ...
 ,references={\cite[p. 125]{book:java-concurrency}, \cite[p. 332]{book:cpj}, \cite[p. 36]{Toub10}, \cite{Leijen09}}
...
\pattern [ name={Thread-local storage}
 ...
 ,relation={ - }
 ,references={\cite[p. 475]{book:posa2}, \cite[p. 45]{book:java-concurrency}, \cite[p. 105 ]{book:cpj}, \cite[p. 53]{Toub10}}
 ,comment={Native support in SCOOP: use \lstinline!once(``THREAD'')! and non-separate return type.}
]

\pattern [name={Publish / Subscribe \todo{find references}}
  ,label={P/S}
  ,category={Program structuring}
...
%   ,relation={maybe observer pattern?}
%  ,references={}
]
