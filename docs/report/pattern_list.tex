...
\pattern [name={Worker Pool}
 ...
 ,references={\cite[p. 117]{book:java-concurrency}, \cite[p. 167]{book:java-concurrency}, \cite[p. 290]{book:cpj},  \cite[p. 61]{Toub10}}
]
...
\pattern [ name={Future}
 ...
 ,references={\cite[p. 125]{book:java-concurrency}, \cite[p. 332]{book:cpj}, \cite[p. 36]{Toub10}}
