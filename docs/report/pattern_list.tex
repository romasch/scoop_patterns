...
\pattern [name={Producer / Consumer}
 ...
 ,references={\cite[p. 87]{book:java-concurrency}}
]
...
\pattern [name={Pipeline}
 ...
 ,references={\cite[p. 253]{book:spp}}
]
...
\pattern [name={Dataflow Network}
 ...
 ,references={\cite[p. 261]{book:spp}}
]
...
\pattern [name={Exchanger}
  ...
  ,references={\cite[p. 101]{book:java-concurrency}}
]
...
\pattern [name={Worker Pool}
 ...
 ,references={\cite[p. 117]{book:java-concurrency}, \cite[p. 167]{book:java-concurrency}}
]
...
\pattern [ name={Future}
 ...
 ,references={\cite[p. 125]{book:java-concurrency}, \cite[p. 332]{book:cpj}}
...
\pattern [name={Executor framework}
  ...
  ,references={\cite[p. 117]{book:java-concurrency}}
]
...
\pattern [name={Timer: Periodic}
  ...
  ,references={\cite[p. 123]{book:java-concurrency}}
]
...
\pattern [ name={Thread-local storage}
 ...
 ,relation={ - }
 ,references={\cite[p. 475]{book:posa2}, \cite[p. 45]{book:java-concurrency}}
...
%   ,relation={}
  ,references={\cite[p. 319]{book:java-concurrency}}
]
...
%   ,relation={}
  ,references={\cite[p. 277]{book:java-concurrency}}
]
...
%   ,relation={}
  ,references={\cite[p. 286]{book:java-concurrency}}
]
...
%   ,relation={Similar to a barrier.}
  ,references={\cite[p. 98]{book:java-concurrency}}
]
...
%   ,relation={Usually implemented with some kind of locking mechanism.}
  ,references={\cite[p. 25]{book:java-concurrency}}
  ]
