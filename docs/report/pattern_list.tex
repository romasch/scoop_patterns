...
\pattern [name={Pipeline}
 ...
 ,references={\cite[p. 305]{book:cpj}, \cite[p. 253]{book:spp}}
]
...
\pattern [name={Worker Pool}
 ...
 ,references={\cite[p. 117]{book:java-concurrency}, \cite[p. 167]{book:java-concurrency}, \cite[p. 290]{book:cpj}}
]
...
\pattern [ name={Thread-local storage}
 ...
 ,relation={ - }
 ,references={\cite[p. 475]{book:posa2}, \cite[p. 45]{book:java-concurrency}, \cite[p. 105 ]{book:cpj}}
