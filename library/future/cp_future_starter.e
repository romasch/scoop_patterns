...
--		local
--			l_cell: separate CP_SHARED_RESULT_BROKER [G, IMPORTER]
--		do
...
--	new_cell_on_pool (a_pool: like result_pool): separate CP_SHARED_RESULT_BROKER [G, IMPORTER]
--		local
--			l_cell: CP_SHARED_RESULT_BROKER [G, IMPORTER]
